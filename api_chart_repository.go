 ...
 * @param optional nil or *ChartRepositoryApiChartrepoChartsPostOpts - Optional Parameters:
     * @param "Prov" (optional.Interface of *os.File) -  The provance file


*/

type ChartRepositoryApiChartrepoChartsPostOpts struct { 
	Prov optional.Interface
}

func (a *ChartRepositoryApiService) ChartrepoChartsPost(ctx context.Context, chart *os.File, localVarOptionals *ChartRepositoryApiChartrepoChartsPostOpts) (*http.Response, error) {
	var (
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoChartsNameGet(ctx context.Context, repo string, name string) (ChartVersions, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param repo The project name
 * @param chart The chart file
 * @param optional nil or *ChartRepositoryApiChartrepoRepoChartsPostOpts - Optional Parameters:
     * @param "Prov" (optional.Interface of *os.File) -  The provance file


*/

type ChartRepositoryApiChartrepoRepoChartsPostOpts struct { 
	Prov optional.Interface
}

func (a *ChartRepositoryApiService) ChartrepoRepoChartsPost(ctx context.Context, repo string, chart *os.File, localVarOptionals *ChartRepositoryApiChartrepoRepoChartsPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ChartRepositoryApiService) ChartrepoRepoProvPost(ctx context.Context, repo string, prov *os.File) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
